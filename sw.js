const CACHE_NAME = 'developer-tools-static-v53';
...
const PRECACHE_URLS = [
  ...
  './src/tools/script-hub-assets.js',
  './src/tools/script-hub.js',
  './src/tools/power-platform-script-hub.ui.js',
  ...
  './src/tools/pcf-development.js',
  './src/tools/pcf-development.ui.js',
  './src/tools/pcf-development-workbench.ui.js',
  ...
  './src/tools/power-platform-classic-workflow-package.ui.js',
  ...
  './src/tools/power-platform-solution-import-preflight.js',
  './src/tools/power-platform-solution-import-preflight.ui.js',
  ...
  './assets/power-platform-script-hub/powershell/library/Backup-PowerPagesSite.ps1',
  './assets/power-platform-script-hub/powershell/library/Compare-PluginRegistration.ps1',
  './assets/power-platform-script-hub/powershell/library/Compare-PowerPagesSites.ps1',
  './assets/power-platform-script-hub/powershell/library/Compare-PowerPlatformEnvironmentSnapshots.ps1',
  './assets/power-platform-script-hub/powershell/library/Get-FlowDeploymentState.ps1',
  './assets/power-platform-script-hub/powershell/library/Get-PluginRegistrationInventory.ps1',
  './assets/power-platform-script-hub/powershell/library/Get-PowerPagesSiteInventory.ps1',
  './assets/power-platform-script-hub/powershell/library/Get-PowerPlatformEnvironmentSnapshot.ps1',
  './assets/power-platform-script-hub/powershell/library/Get-SolutionDeploymentHistory.ps1',
  './assets/power-platform-script-hub/powershell/library/Sync-PowerPagesSite.ps1',
  './assets/power-platform-script-hub/powershell/library/Test-EnvironmentReferences.ps1',
  './assets/power-platform-script-hub/powershell/library/Test-PCFProjectHealth.ps1',
  './assets/power-platform-script-hub/powershell/library/Test-PCFReleasePackage.ps1',
  './assets/power-platform-script-hub/powershell/library/Test-SolutionTargetReadiness.ps1',
  './assets/power-platform-script-hub/powershell/pcf/Build-And-Deploy-PCF.ps1',
  './assets/power-platform-script-hub/powershell/pcf/Deploy-Solution.ps1',
  './assets/power-platform-script-hub/powershell/pcf/Get-PCFDevEnvironmentReport.ps1',
  './assets/power-platform-script-hub/powershell/pcf/Initialize-NewPCFProject.ps1',
  './assets/power-platform-script-hub/powershell/pcf/Invoke-SolutionCheck.ps1',
  './assets/power-platform-script-hub/powershell/pcf/New-PCFIdentityClone.ps1',
  './assets/power-platform-script-hub/powershell/pcf/PCF.Common.ps1',
  './assets/power-platform-script-hub/powershell/pcf/Push-PCFQuickDeploy.ps1',
  './assets/power-platform-script-hub/powershell/pcf/Set-PCFReleaseDefaults.ps1',
  './assets/power-platform-script-hub/powershell/pcf/Start-PCFTestHarness.ps1',
  './assets/power-platform-script-hub/powershell/pcf/Test-PCFProjectConfiguration.ps1',
  './assets/power-platform-script-hub/powershell/pcf/Test-PCFReleaseArtifact.ps1',
  './assets/power-platform-script-hub/powershell/pcf/Test-PCFToolingPackage.ps1',
  './assets/power-platform-script-hub/powershell/pcf/Update-Version.ps1',
  './assets/power-platform-script-hub/forensics/App-Module-Forensics.txt',
  './assets/power-platform-script-hub/forensics/Async-Operations-Health.txt',
  './assets/power-platform-script-hub/forensics/BPF-Forensics.txt',
  './assets/power-platform-script-hub/forensics/Compare-Environment-Fingerprints.txt',
  './assets/power-platform-script-hub/forensics/Component-Forensics-Generic.txt',
  './assets/power-platform-script-hub/forensics/Environment-Fingerprint.txt',
  './assets/power-platform-script-hub/forensics/Environment-Reference-Audit.txt',
  './assets/power-platform-script-hub/forensics/Flow-Forensics.txt',
  './assets/power-platform-script-hub/forensics/Form-Forensics.txt',
  './assets/power-platform-script-hub/forensics/PCF-Forensics-Generic.txt',
  './assets/power-platform-script-hub/forensics/Plugin-Step-Forensics.txt',
  './assets/power-platform-script-hub/forensics/Security-Role-Audit.txt',
  './assets/power-platform-script-hub/forensics/Security-Role-Diff.txt',
  './assets/power-platform-script-hub/forensics/Solution-Forensics-Generic.txt',
  './assets/power-platform-script-hub/forensics/WebResource-Integrity-Audit.txt',
